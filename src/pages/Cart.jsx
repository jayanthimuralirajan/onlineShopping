...
function Cart() {
  ...
  return (
   ...
   <p>Your cart is empty.</p>):<p></p>
    ...
    <div className="p-9 bg-slate-100 m-10 rounded-lg shadow-lg">
  <h1 className="text-2xl font-semibold text-gray-800 border-b pb-2 mb-4">ORDER SUMMARY</h1>
  <div className="space-y-3">
    <span className="text-lg text-gray-700 mr-28">Total:</span>{total}<p></p>
    <span className="text-lg text-gray-700  pb-2 mr-2 inline-block">Estimate Shipping:</span>{eShipping}
    <p className='border-b'></p>
    
    <span className="text-xl font-semibold text-gray-800 mr-16 pr-2">Subtotal:</span><span className='text-xl font-semibold'>{total+eShipping}</span>
  </div>
